...
from PyQt5.QtWidgets import (
    QPushButton, QLabel, QWidget, QSpinBox, QRadioButton, QGroupBox, QButtonGroup, 
...
lbl_question = QLabel("")
line2.addWidget(lbl_question, alignment=(Qt.AlignCenter|Qt.AlignVCenter))
...
#card_win.setLayout(RadioGroupBox)
